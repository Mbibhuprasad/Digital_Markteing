    ...
    <nav className="bg-white shadow-md fixed w-full z-50">
      <div className="max-w-10xl mx-auto px-8 flex justify-between items-center h-16">
          ...
          {menuItems.map((item, index) => (
            <li key={index} className="relative">
              <button
                ...
                className="hover:text-[#8BD005] transition"
              >
                {item.title}
              </button>
        ...
        <div className="flex items-center space-x-4">
          <button className="text-sm font-medium text-gray-600 hover:text-[#8BD005]">
            Search
          </button>
          <button className="text-sm font-medium text-gray-600 hover:text-[#8BD005]">
            Client Login
          </button>
          <button className="px-4 py-2 bg-[#8BD005] text-white rounded-lg hover:bg-[#7BBE04]">
            Get a Proposal
          </button>
        </div>
      </div>
